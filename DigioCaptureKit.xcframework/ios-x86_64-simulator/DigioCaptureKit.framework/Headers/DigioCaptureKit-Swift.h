...
#ifndef DIGIOCAPTUREKIT_SWIFT_H
#define DIGIOCAPTUREKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DigioCaptureKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC15DigioCaptureKit17CameraGraphicView")
...
+ (void)presentFrom:(UIViewController * _Nonnull)parent config:(CameraConfig * _Nullable)config completion:(void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, UIImage * _Nonnull, CLLocation * _Nullable, CGRect, NSString * _Nullable))completion onCancel:(void (^ _Nonnull)(NSString * _Nullable))onCancel onEvent:(void (^ _Nonnull)(NSString * _Nullable))onEvent;
/// this function get trigger from iosKycSDK from CaptureKitHelper under  launchCameraIfAvailable function
+ (void)presentFrom:(UIViewController * _Nonnull)parent mode:(NSString * _Nonnull)mode config:(CameraConfig * _Nullable)config completion:(void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, UIImage * _Nonnull, CLLocation * _Nullable, CGRect, NSString * _Nullable))completion onCancel:(void (^ _Nonnull)(NSString * _Nullable))onCancel onEvent:(void (^ _Nonnull)(NSString * _Nullable))onEvent;
...
SWIFT_CLASS("_TtC15DigioCaptureKit10CameraView")
...
SWIFT_CLASS("_TtC15DigioCaptureKit17PermissionManager")
